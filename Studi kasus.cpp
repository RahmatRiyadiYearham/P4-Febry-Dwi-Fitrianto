...
void login(){
	awal:
		...
		if(username=="RahmatRY"&&pass=="11032002"){
		system("cls");
			cout<<"|===============================|"<<endl;
			cout<<"| SELAMAT DATANG MAHASISWA |"<<endl;
			cout<<"|===============================|"<<endl;
			cout<<"| DATA MAHASISWA |"<<endl;
			cout<<"| Rahmat Riyadi Yearham |"<<endl;
			cout<<"| F1B019118 |"<<endl;
...
int main(){
	...
	cout<<"========================================================================================================================"<<endl;
	for(o=0;o<p;o++){
		mahasiswa[o].nilai=(mahasiswa[o].kehadiran*10/100)+(mahasiswa[o].tugas*15/100)+(mahasiswa[o].kuis*15/100)+(mahasiswa[o].uts*20/100)+(mahasiswa[o].uas*40/100);
